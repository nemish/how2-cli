...
var commandLine_1 = __importDefault(require("./utils/commandLine"));
var readPackageJson_1 = __importDefault(require("./utils/readPackageJson"));
...
var showOptions = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, readPackageJson_1.default)()];
            case 1:
                packageJson = _a.sent();
                (0, emptyLine_1.default)();
                console.log((0, chalk_1.cyanBright)("#### Howpage: " + packageJson.name));
                (0, delimiter_1.default)({
                    symbol: '*',
                });
                return [4 /*yield*/, (0, showScripts_1.default)(packageJson.scripts)];
            case 2:
                _a.sent();
