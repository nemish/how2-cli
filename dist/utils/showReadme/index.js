...
var handleData = function (_a) {
    ...
    if (lines.length !== linesToShow.length) {
        ...
        console.log((0, chalk_1.yellow)(linesToShow.length + " of " + lines.length + " lines shown. To see more type \"readme\" command."));
    }
};
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                (0, emptyLine_1.default)();
                console.log((0, chalk_1.grey)('README.md'));
                ...
                return [4 /*yield*/, (0, doReadFile_1.default)({
                        ...
                        .catch(function (err) { return console.log((0, chalk_1.red)('There is no README.md file')); })];
            case 1:
                _a.sent();
                (0, emptyLine_1.default)();
                (0, delimiter_1.default)();
